...
will take in an array of words and capitalize them, and then the second function, sortWords(), will sort the words in alphabetical order. 
If the array contains anything but strings, it should throw an error.
Then call these functions by *chaining* the promises
*/

// const makeAllCaps = () => {
//     let x = arrayOfWords.lenght
//     return x.toUpperCase();
// }; 
const arrayOfWords = ['cucumber', 'tomatos', 'avocado'];
let makeAllCaps = arrayOfWords.map(function toUpper(item) {
